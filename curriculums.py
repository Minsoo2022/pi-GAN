...
CelebA_128 = {
    ...
    0: {'batch_size': 120, 'num_steps': 24, 'img_size': 32, 'batch_split': 6, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    int(10e3): {'batch_size': 28, 'num_steps': 24, 'img_size': 64, 'batch_split': 4, 'gen_lr': 2e-5, 'disc_lr': 2e-4},
    int(55e3): {'batch_size': 12, 'num_steps': 24, 'img_size': 128, 'batch_split': 10, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    int(200e3): {},
...
CATS_128 = {
    ...
    int(55e3): {'batch_size': 12, 'num_steps': 24, 'img_size': 128, 'batch_split': 10, 'gen_lr': 10e-6,
                'disc_lr': 10e-5},
    int(200e3): {},
    # 0: {'batch_size': 120, 'num_steps': 24, 'img_size': 32, 'batch_split': 2, 'gen_lr': 4e-5, 'disc_lr': 4e-4},
    # int(2): {'batch_size': 32, 'num_steps': 24, 'img_size': 64, 'batch_split': 2, 'gen_lr': 2e-5, 'disc_lr': 2e-4},
    # int(4): {'batch_size': 12, 'num_steps': 24, 'img_size': 128, 'batch_split': 4, 'gen_lr': 10e-6, 'disc_lr': 10e-5},
    # int(6): {},
